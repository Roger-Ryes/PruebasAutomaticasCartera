...
public class LoansCreateFormForm{
	...
	private LoansCreateFormForm() {
		throw new IllegalStateException("LoansCreateFormForm is a utility class");
	}
	public static class Layouts {
		private Layouts() {
			throw new IllegalStateException("Layouts is a utility class");
		}
		public static final LytViewContainerBaseIdVCZHQUMTXXGR635193 lytViewContainerBaseIdVCZHQUMTXXGR635193 = Singleton.getInstance(LytViewContainerBaseIdVCZHQUMTXXGR635193.class);
		
		public static class LytViewContainerBaseIdVCZHQUMTXXGR635193 extends COBISTab {
			public LytViewContainerBaseIdVCZHQUMTXXGR635193(){
				this.init("VC_ZHQUMTXXGR_635193", "Información General");
			}
		}
		
		public static final LytViewContainerBaseIdVCZUGXQMZUBQ554193 lytViewContainerBaseIdVCZUGXQMZUBQ554193 = Singleton.getInstance(LytViewContainerBaseIdVCZUGXQMZUBQ554193.class);
		
		public static class LytViewContainerBaseIdVCZUGXQMZUBQ554193 extends COBISTab {
			public LytViewContainerBaseIdVCZUGXQMZUBQ554193(){
				this.init("VC_ZUGXQMZUBQ_554193", "Rubros");
			}
		}
		
		public static final LytViewContainerBaseIdVCUQBPHFCKCW777193 lytViewContainerBaseIdVCUQBPHFCKCW777193 = Singleton.getInstance(LytViewContainerBaseIdVCUQBPHFCKCW777193.class);
		
		public static class LytViewContainerBaseIdVCUQBPHFCKCW777193 extends COBISTab {
			public LytViewContainerBaseIdVCUQBPHFCKCW777193(){
				this.init("VC_UQBPHFCKCW_777193", "Parámetros Generales");
			}
		}
		
		public static final LytViewContainerBaseIdVCBKTCDNSADU521193 lytViewContainerBaseIdVCBKTCDNSADU521193 = Singleton.getInstance(LytViewContainerBaseIdVCBKTCDNSADU521193.class);
		
		public static class LytViewContainerBaseIdVCBKTCDNSADU521193 extends COBISTab {
			public LytViewContainerBaseIdVCBKTCDNSADU521193(){
				this.init("VC_BKTCDNSADU_521193", "Amortización");
			}
		}
	...
	public static class Buttons {
		...
		public static final CmdCommand1IdCMTLNSPRMBTRO cmdCommand1IdCMTLNSPRMBTRO = Singleton.getInstance(CmdCommand1IdCMTLNSPRMBTRO.class);
		
		public static class CmdCommand1IdCMTLNSPRMBTRO extends COBISButton{
			public CmdCommand1IdCMTLNSPRMBTRO () {
				this.init("CM_TLNSPRMB_TRO", "Transmitir");
			}
		}
	...
	public static class MessageInformation {
		private MessageInformation() {
			throw new IllegalStateException("MessageInformation is a utility class");
		}
		public static final BtnCloseMessageSuccess btnCloseMessageSuccess = Singleton.getInstance(BtnCloseMessageSuccess.class);
		public static class BtnCloseMessageSuccess extends COBISButton {
			public BtnCloseMessageSuccess(){
				this.init("","MessageSuccessfulBulding", "//div[contains(@class,'kiui-notification-close')]/span[contains(@class,'k-icon k-i-close')]");
			}
		}
				
		public static final MessageSuccessfulBulding messageSuccessfulBulding = Singleton.getInstance(MessageSuccessfulBulding.class);
		public static class MessageSuccessfulBulding extends COBISInputValue {
			public MessageSuccessfulBulding(){
				this.init("","MessageSuccessfulBulding", "//div[contains(@class,'ng-binding ng-scope')]");
			}
		}
		
		public static final MessageSuccessfulTransmition messageSuccessfulTransmition = Singleton.getInstance(MessageSuccessfulTransmition.class);
		public static class MessageSuccessfulTransmition extends COBISInputValue {
			public MessageSuccessfulTransmition(){
				this.init("","MessageSuccessfulTransmition", "/html/body/div[22]/div/div[4]/div[contains(@class,'ng-binding ng-scope')]");
			}
		}
	}
