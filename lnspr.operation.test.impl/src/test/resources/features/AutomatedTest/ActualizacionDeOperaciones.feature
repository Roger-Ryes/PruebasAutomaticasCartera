...
Característica: Verificar la correcta creacion de un prestamo para una persona natural y persona juridica, moneda base, con tipo de pago mensual
  ...
  Esquema del escenario: Actualizacion de un Prestamo para una Persona Natural, Pestaña Amortizacion
    ...
    Ejemplos: 
      ...
      | 'Num. Préstamo' | '0001000298'      | '20042021' | ''        | ''    | ''            | ''    | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | ''          | ''               |
      ...
      | 'Num. Préstamo' | '0001000299'      | ''         | ''        | ''    | 'M - MES(ES)' | '12'  | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | ''          | ''               |
      ...
      | 'Num. Préstamo' | '0001000301'      | ''         | ''        | ''    | ''            | ''    | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | 'COMERCIAL' | ''               |
  ...
  Esquema del escenario: Actualizacion de un Prestamo para una Persona Natural, Pestaña Amortizacion
    ...
    Ejemplos: 
      | BuscarPor       | numeroDeOperacion | FechaValor | TasaTotal | Cuota | TipoPlazo | Plazo | TipoCuota | FechaVencimiento | FechaDePagoFija | DiaDePago | Pint | Pcap | FechaDePagoExtendido | GraciaMora | MesGracia | PerGraciaCapital | PerGraciaInteres | BaseCalculo | TipoAmortizacion |
      # QA-CAR-S518517 -Esc1 - Actualización de un préstamo de Crédito Individual, Pestaña Amortización, opción Fecha Valor, para persona jurídica con moneda en dólares
      | 'Num. Préstamo' | '0001000288'      | '20042021' | ''        | ''    | ''        | ''    | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | ''          | ''               |
      # QA-CAR-S518517 -Esc2 - Actualización de un préstamo de Crédito Individual, Pestaña Amortización, opción Plazo, para persona jurídica con moneda en dólares
      | 'Num. Préstamo' | '0001000289'      | ''         | ''        | ''    | ''        | '6'   | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | ''          | ''               |
      # QA-CAR-S518517 -Esc3 - Actualización de un préstamo de Crédito Individual, Pestaña Amortización, opción Fecha de Pago Fija, para persona jurídica con moneda en dólares
      | 'Num. Préstamo' | '0001000291'      | ''         | ''        | ''    | ''        | ''    | ''        | ''               | 'X'             | '6'       | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | ''          | ''               |
      # QA-CAR-S518517 -Esc4 - Actualización de un préstamo de Crédito Individual, Pestaña Amortización, opción Base de Cálculo, para persona jurídica con moneda en dólares
      | 'Num. Préstamo' | '0001000292'      | ''         | ''        | ''    | ''        | ''    | ''        | ''               | ''              | ''        | ''   | ''   | ''                   | ''         | ''        | ''               | ''               | 'COMERCIAL' | ''               |
