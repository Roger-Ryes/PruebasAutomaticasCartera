...
public class LoanDisbursementMainForm{
	...
	private LoanDisbursementMainForm() {
		throw new IllegalStateException("LoanDisbursementMainForm is a utility class");
	}
	public static class Buttons {
		private Buttons() {
			throw new IllegalStateException("Buttons is a utility class");
		}
		public static final CmdCommand1IdCMTLOANDISS5N cmdCommand1IdCMTLOANDISS5N = Singleton.getInstance(CmdCommand1IdCMTLOANDISS5N.class);
		
		public static class CmdCommand1IdCMTLOANDISS5N extends COBISButton{
			public CmdCommand1IdCMTLOANDISS5N () {
				this.init("CM_TLOANDIS_S5N", "Enviar");
			}
		}
